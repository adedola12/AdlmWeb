...
// Ported from RichardEnoch/adlm-studio-site src/dash-settings.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashSettings() {
  return (
    <>
      <div className="dsh">
        {" "}
          ...
          <div className="dsh-in">
            ...
            <div className="dsh-head">
              ...
              <div>
                ...
                {" "}
                <p>
                  One ADLM account signs into every product, on every machine. What you change here changes it everywhere, including inside Revit and PlanSwift.
                </p>
                {" "}
              </div>
              {" "}
              ...
              <div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    ...
                    {" "}
                    <form data-fb="profile" className="dsh-form" action="/manage/settings" method="get" style={{ maxWidth: "none" }}>
                      {" "}
                      <div className="two">
                        {" "}
                        <div className="ds-field">
                          ...
                          {" "}
                          <input id="st-name" name="name" type="text" value="Tunde Adeyemi" />
                        </div>
                        {" "}
                        <div className="ds-field">
                          ...
                          {" "}
                          <input id="st-role" name="role" type="text" value="Principal Partner" />
                        </div>
                        {" "}
                      </div>
                      {" "}
                      <div className="two">
                        {" "}
                        <div className="ds-field">
                          <label htmlFor="st-mail">
                            Work email
                          </label>
                          {" "}
                          <input id="st-mail" name="email" type="email" value="tunde@adeyemipartners.ng" />
                        </div>
                        {" "}
                        <div className="ds-field">
                          <label htmlFor="st-tel">
                            Phone
                          </label>
                          {" "}
                          <input id="st-tel" name="phone" type="tel" value="+234 802 114 9080" />
                        </div>
                        {" "}
                      </div>
                      {" "}
                      <div>
                        <button className="ds-btn btn-p ds-btn-sm" type="submit">
                          Save profile
                        </button>
                      </div>
                      {" "}
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    {" "}
                    <form data-fb="firm" className="dsh-form" action="/manage/settings" method="get" style={{ maxWidth: "none" }}>
                      {" "}
                      <div className="two">
                        {" "}
                        <div className="ds-field">
                          <label htmlFor="st-firm">
                            Practice name
                          </label>
                          {" "}
                          <input id="st-firm" name="firm" type="text" value="Adeyemi &amp; Partners" />
                        </div>
                        {" "}
                        <div className="ds-field">
                          <label htmlFor="st-tin">
                            TIN{" "}
                            <span className="opt">
                              optional
                            </span>
                          ...
                          {" "}
                          <input id="st-tin" name="tin" type="text" placeholder="Appears on future invoices" />
                        </div>
                        {" "}
                      </div>
                      {" "}
                      <div className="ds-field">
                        ...
                        {" "}
                        <input id="st-addr" name="address" type="text" value="Ikoyi, Lagos, Nigeria" />
                      </div>
                      {" "}
                      <div>
                        <button className="ds-btn btn-p ds-btn-sm" type="submit">
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    {" "}
                    <form data-fb="password" className="dsh-form" action="/manage/settings" method="get">
                      {" "}
                      <div className="ds-field">
                        ...
                        {" "}
                        <input id="st-old" name="old" type="password" autoComplete="current-password" />
                      </div>
                      {" "}
                      <div className="ds-field">
                        <label htmlFor="st-new">
                          New password
                        </label>
                        {" "}
                        <input id="st-new" name="new" type="password" autoComplete="new-password" />
                        {" "}
                        <p className="hint">
                          Changing it signs the other machines out at their next check-in.
                        </p>
                      </div>
                      {" "}
                      <div>
                  ...
                  <div className="dsh-body">
                    ...
                    <div className="dsh-dl">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          QUIV · Lagos · active today · this machine
                        </span>
                      </div>
                      {" "}
                    </div>
                    ...
                    <div className="dsh-dl">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          QUIV, RateGen · Lagos · active yesterday
                        </span>
                      </div>
                      {" "}
                      <a className="ds-btn btn-o ds-btn-sm" href="#" data-fb-toast="success|Signed out of CHIDI-LT01|That machine asks for a password the next time QUIV or RateGen opens.">
                        Sign out
                      </a>
                      {" "}
                    </div>
                  ...
                  <div className="dsh-body">
                    ...
                    <label className="dsh-toggle">
                      ...
                      <span>
                        ...
                        <p>
                          When a build ships for something you are licensed for.
                        </p>
                      </span>
                      {" "}
                    </label>
                    ...
                    <label className="dsh-toggle">
                      ...
                      <span>
                        ...
                        <p>
                          Invoices, renewals and anything that changes what you pay.
                        </p>
                      </span>
                      {" "}
                    </label>
                    ...
                    <label className="dsh-toggle">
                      ...
                      <span>
                        ...
                        <p>
                          When a seat is assigned, freed, or a member joins.
                        </p>
                      </span>
                      {" "}
                    </label>
                    ...
                    <label className="dsh-toggle">
                      ...
                      <span>
                        ...
                        <p>
                          New courses, training dates and free lessons. Off by default.
                        </p>
                      </span>
                      {" "}
                    </label>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    ...
                    <p style={{ margin: "0", fontSize: "13px", fontWeight: "300", color: "var(--ink-3)", lineHeight: "1.65" }}>
                      {" "}Rate libraries, projects and takeoffs belong to the practice, not to a licence. They stay in the account if a subscription lapses, and can be exported at any time.
                    </p>
                    {" "}
                    <div style={{ display: "flex", gap: "10px", marginTop: "16px", flexWrap: "wrap" }}>
                      {" "}
                      <a className="ds-btn btn-o ds-btn-sm" href="#" data-fb-toast="info|Preparing your export|We email a download link to tunde@adeyemipartners.ng within the hour. It expires after 48 hours.">
                        Export account data
                      </a>
                      {" "}
                      <button type="button" className="ds-btn btn-o ds-btn-sm" data-modal="privacy">
                        Privacy
                      </button>
                      {" "}
                    </div>
