...
// Ported from RichardEnoch/adlm-studio-site src/admin-rates.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminRates() {
  return (
    <>
      {/* bar Rate data | Catalogue */}
      {" "}
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/rates" className="on" aria-current="page" data-tip="Rate data">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#wi-library" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    The material and labour prices RateGen builds rates from. ADLM researches these and every user in the country prices against them, so edits are drafted and published as a version, and each price carries where it came from and when it was last checked.
                  </p>
                  {" "}
                </div>
                {" "}
