...
// Ported from RichardEnoch/adlm-studio-site src/admin-enrolments.html
      ...
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/enrolments" className="on" aria-current="page" data-tip="Enrolments">
                <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="adm-page-in">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Somebody paid to sit a course and uploaded a proof. Approving one spends a seat, so a course with none left cannot take another however good the proof is.
                  </p>
                  {" "}
                </div>
                {" "}
              ...
              <section className="adm-panel">
                ...
                <div className="adm-panel-h">
                  ...
                  {" "}
                  <span className="note">
                    Every physical training that is open
                  </span>
                  {" "}
                </div>
                {" "}
                <div className="adm-panel-b">
                  {" "}
                  <div className="adm-bars" id="adm-seats">
                  </div>
                  {" "}
                </div>
                {" "}
              ...
              <div className="adm-toolrow">
                ...
                <label className="adm-switch">
                  {" "}
                  <input type="checkbox" id="adm-bygroup" />
                  {" "}
                  <span>
              ...
              <div className="adm-bulk" id="adm-bulk" hidden={true}>
                ...
                <div className="adm-bulk-acts">
                  ...
                  {" "}
                  <button type="button" className="adm-b" data-bulk="rejected">
                    Reject selected
                  </button>
                  {" "}
                  <button type="button" className="adm-b pri" data-bulk="approved">
                    Approve selected
                  </button>
                  {" "}
                </div>
