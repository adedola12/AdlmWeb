...
// Ported from RichardEnoch/adlm-studio-site src/dash-team.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashTeam() {
  return (
    <>
      <div className="dsh">
        {" "}
          ...
          <div className="dsh-in">
            ...
            <div className="dsh-head">
              ...
              <div>
                ...
                {" "}
                <p>
                  Five people on the account and five seats bought, but only three seats are being used. A seat follows the machine, so moving one takes about a minute.
                </p>
                {" "}
              </div>
              {" "}
              <div className="dsh-acts">
                ...
                {" "}
                <a className="ds-btn btn-p ds-btn-sm" href="#invite">
                  Invite a member
                </a>
                {" "}
              </div>
            ...
            {" "}
            <div className="dsh-two" data-team="">
              {" "}
              <div>
                {" "}
                        ...
                        <tr data-member="">
                          ...
                          <td>
                            <div className="dsh-chips">
                              ...
                              <button type="button" className="dsh-chip" data-seat="rategen" aria-pressed="false">
                                <img src="/ds/ic-rategen.png" alt="" />
                                RateGen
                              </button>
                              <button type="button" className="dsh-chip" data-seat="heron" aria-pressed="false">
                                <img src="/ds/ic-heron.png" alt="" />
                                HERON
                              </button>
                            </div>
                        ...
                        <tr data-member="">
                          ...
                          <td>
                            <div className="dsh-chips">
                              ...
                              <button type="button" className="dsh-chip on" data-seat="rategen" aria-pressed="true">
                                <img src="/ds/ic-rategen.png" alt="" />
                                RateGen
                              </button>
                              <button type="button" className="dsh-chip" data-seat="heron" aria-pressed="false">
                ...
                {" "}
                <section className="dsh-panel" id="invite">
                  {" "}
                  <div className="dsh-ph">
                    <h2>
                      Invite a member
                  ...
                  <div className="dsh-body">
                    {" "}
                    <form data-fb="invite" className="dsh-form" action="/manage/team" method="get" style={{ maxWidth: "none" }}>
                      {" "}
                      <div className="two">
                        {" "}
                        <div className="ds-field">
                          ...
                          {" "}
                          <input id="iv-name" name="name" type="text" placeholder="Halima Yusuf" required={true} />
                        </div>
                        {" "}
                        <div className="ds-field">
                          <label htmlFor="iv-mail">
                            Work email
                          </label>
                          {" "}
                          <input id="iv-mail" name="email" type="email" placeholder="name@adeyemipartners.ng" required={true} />
                        </div>
                        {" "}
                      </div>
                      {" "}
                      <div className="two">
                        ...
                        <div className="ds-field">
                          ...
                          {" "}
                          <input id="iv-role" name="role" type="text" placeholder="Quantity Surveyor" />
                        </div>
                        {" "}
                        <div className="ds-field">
                          <label htmlFor="iv-seat">
                            Give them a seat on
                          </label>
                          {" "}
                          <select id="iv-seat" name="seat" data-spare="">
                          </select>
                        </div>
                        {" "}
                      </div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    ...
                    <div className="dsh-meter">
                      {" "}
                      <div className="row" data-meter="quiv">
                        {" "}
                        <div className="lab">
                          <span>
                            QUIV
                        ...
                        {" "}
                        <div className="track">
                          <i className="full" style={{ width: "100%" }}>
                          </i>
                        </div>
                        {" "}
                      </div>
                      {" "}
                      <div className="row" data-meter="rategen">
                        {" "}
                        <div className="lab">
                          <span>
                            RateGen
                      ...
                      {" "}
                      <div className="row" data-meter="heron">
                        {" "}
                        <div className="lab">
                          <span>
                            HERON
                    ...
                    {" "}
                    <p style={{ margin: "18px 0 0", fontSize: "12.5px", fontWeight: "300", color: "var(--ink-3)", lineHeight: "1.6" }}>
                      {" "}
                      <span data-idle="">
                        Two seats are paid for and idle. Assigning one costs nothing.
                      </span>
                    </p>
                    {" "}
                  </div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    ...
                    <p style={{ margin: "16px 0 0", fontSize: "12.5px", fontWeight: "300", color: "var(--ink-3)", lineHeight: "1.6" }}>
                      {" "}Activation is tied to the device, not the network: switching between Wi-Fi, ethernet or a VPN does not use up an activation.
                    </p>
                    {" "}
                  </div>
                  {" "}
