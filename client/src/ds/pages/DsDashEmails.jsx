...
// Ported from RichardEnoch/adlm-studio-site src/dash-emails.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashEmails() {
  return (
    <>
      <div className="dsh">
        {" "}
          ...
          <div className="dsh-in">
            ...
            <div className="wk-head">
              ...
              <div className="wk-acts">
                {" "}
                <div className="wk-loc-sw" id="em-width" aria-label="Preview width">
                </div>
                {" "}
              </div>
              {" "}
            ...
            <div className="em-split">
              {" "}
              <aside className="em-list" id="em-list">
              </aside>
              {" "}
              <section className="em-stage">
                {" "}
                <div className="em-meta" id="em-meta">
                </div>
                {" "}
                <div className="em-frame">
                  <iframe id="em-frame" title="Email preview">
                  </iframe>
                </div>
                {" "}
              </section>
