...
// Ported from RichardEnoch/adlm-studio-site src/admin-subscriptions.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminSubscriptions() {
  return (
    <>
      {/* bar Subscriptions | Commerce */}
      {" "}
      <div className="adm-shell" data-screen="subscriptions">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/subscriptions" className="on" aria-current="page" data-tip="Subscriptions">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-shield" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Every licence ADLM has sold, with the ones about to lapse first. A subscription is what an entitlement hangs off, so disabling one quietly switches things off elsewhere, which is why the state is on the row rather than hidden.
                  </p>
                  {" "}
                </div>
                {" "}
