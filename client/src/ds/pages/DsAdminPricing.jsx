...
// Ported from RichardEnoch/adlm-studio-site src/admin-pricing.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminPricing() {
  return (
    <>
      {/* bar Price book | Catalogue */}
      {" "}
      <div className="adm-shell" data-screen="pricing">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/pricing" className="on" aria-current="page" data-tip="Price book">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-doc" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    One place for what a licence costs, so the website, the quotation builder and an invoice cannot disagree. A zone is a factor on the naira figure rather than a separate price list to keep in step.
                  </p>
                  {" "}
                </div>
                {" "}
