...
// Ported from RichardEnoch/adlm-studio-site src/admin-quotations.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminQuotations() {
  return (
    <>
      {/* bar Quotations | Commerce */}
      {" "}
      <div className="adm-shell" data-screen="quotations">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/quotations" className="on" aria-current="page" data-tip="Quotations">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-quote" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Quotes people built for themselves on the website and kept. One that has been sitting a fortnight is a sales conversation nobody has had, and it can become an invoice without anybody retyping it.
                  </p>
                  {" "}
                </div>
                {" "}
