...
// Ported from RichardEnoch/adlm-studio-site src/admin-courses.html
...
export default function DsAdminCourses() {
  return (
    <>
      {/* bar Courses | Learning */}
      {" "}
      <div className="adm-shell" data-screen="courses">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/courses" className="on" aria-current="page" data-tip="Courses">
                <svg viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Everything on demand: the free videos and the paid courses, in one place because they are the same object with a price on one of them. The column that matters is where people stop.
                  </p>
                  {" "}
                </div>
                {" "}
