...
// Ported from RichardEnoch/adlm-studio-site src/admin-submissions.html
      ...
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/submissions" className="on" aria-current="page" data-tip="Submissions">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-check" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Course work handed in and not yet marked, oldest first. This is a queue rather than a list because the thing on the other side of it, a certificate on the ADLM template, is owed to somebody until it is cleared.
                  </p>
                  {" "}
                </div>
                {" "}
