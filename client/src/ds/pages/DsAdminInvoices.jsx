...
// Ported from RichardEnoch/adlm-studio-site src/admin-invoices.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminInvoices() {
  return (
    <>
      {/* bar Invoices | Commerce */}
      {" "}
      <div className="adm-shell" data-screen="invoices">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/invoices" className="on" aria-current="page" data-tip="Invoices">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-billing" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Everything ADLM has billed, produced by the same document engine as every other piece of ADLM paper. An invoice keeps the VAT rate it was issued under, so changing the rate never rewrites what was already sent.
                  </p>
                  {" "}
                </div>
                {" "}
