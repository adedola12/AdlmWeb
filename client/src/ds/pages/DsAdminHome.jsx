...
// Ported from RichardEnoch/adlm-studio-site src/admin-home.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminHome() {
  return (
    <>
      {/* bar Today | ADLM admin */}
      {" "}
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin" className="on" aria-current="page" data-tip="Today">
                <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="adm-page-in">
              ...
              <div className="adm-banner">
                ...
                <span>
                  {" "}
                  <b>
                    Today and Purchases are built. The rest of the rail is not.
                  </b>
                  {" "}
                  <p>
                    Dimmed rows are screens that do not exist yet, kept visible so the shape of the surface can be argued with before it is coded. Every figure here is computed from the admin model, never typed into the page, and a dash means no queue exists, which is not the same as a zero.
                  </p>
                  {" "}
                </span>
                {" "}
              ...
              {" "}
              <div className="adm-kpis" id="adm-kpis">
              </div>
              {" "}
              <div className="adm-cols">
                ...
                <div>
                  ...
                  <section className="adm-panel">
                    ...
                    <div className="adm-panel-h">
                      ...
                      {" "}
                      <span className="note" id="adm-waiting">
                      </span>
                      {" "}
                    </div>
                    {" "}
                    <div className="adm-panel-b">
                      {" "}
                      <ul className="adm-jobs" id="adm-work">
                      </ul>
                      {" "}
                    </div>
                    {" "}
                  ...
                  <section className="adm-panel">
                    ...
                    <div className="adm-panel-h">
                      ...
                      {" "}
                      <span className="note">
                        Nothing to do yet, but it will need doing
                      </span>
                      {" "}
                    </div>
                    {" "}
                    <div className="adm-panel-b">
                      {" "}
                      <ul className="adm-jobs" id="adm-watch">
                      </ul>
                      {" "}
                    </div>
                    {" "}
                ...
                <div>
                  ...
                  <section className="adm-panel">
                    ...
                    <div className="adm-panel-b">
                      {" "}
                      <div className="adm-bars" id="adm-chart-q">
                      </div>
                      {" "}
                  ...
                  <section className="adm-panel">
                    ...
                    <div className="adm-panel-b">
                      {" "}
                      <div className="adm-hero" id="adm-hero">
                      </div>
                      {" "}
                      <div className="adm-bars" id="adm-chart-m">
                      </div>
                      {" "}
                    </div>
                    {" "}
