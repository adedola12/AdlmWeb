...
// Ported from RichardEnoch/adlm-studio-site src/dash-billing.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashBilling() {
  return (
    <>
      <div className="dsh">
        {" "}
          ...
          <div className="dsh-in">
            ...
            <div className="dsh-head">
              ...
              <div>
                ...
                {" "}
                <p data-bill-note="">
                  Monthly, five seats, ₦137,600 on 7 September. Yearly billing costs ten months instead of twelve.
                </p>
                {" "}
              </div>
              {" "}
            ...
            {" "}
            <div className="dsh-two" data-bill="">
              {" "}
              <div>
                {" "}
                <section className="dsh-panel">
                  ...
                  <div className="dsh-ph">
                    ...
                    <div className="dsh-seg">
                      {" "}
                      <button type="button" data-c="monthly" className="on">
                        Monthly
                      </button>
                      {" "}
                      <button type="button" data-c="yearly">
                        Yearly
                      </button>
                      {" "}
                    </div>
                  ...
                  <div className="dsh-body">
                    {" "}
                    <p style={{ margin: "14px 0 4px", fontSize: "12.5px", color: "var(--ink-3)" }} data-period="">
                      Every month · next on 7 September 2026
                    </p>
                    {" "}
                    <div className="dsh-kv">
                      ...
                      <div data-line="quiv">
                        ...
                        <span className="dsh-step">
                          {" "}
                          <button type="button" data-step="-1" aria-label="One fewer QUIV seat">
                            −
                          </button>
                          {" "}
                          <span className="n" data-line-n="">
                            2
                          </span>
                          {" "}
                          <button type="button" data-step="1" aria-label="One more QUIV seat">
                            +
                          </button>
                          {" "}
                        </span>
                      ...
                      <div data-line="rategen">
                        ...
                        <span className="dsh-step">
                          {" "}
                          <button type="button" data-step="-1" aria-label="One fewer RateGen seat">
                            −
                          </button>
                          {" "}
                          <span className="n" data-line-n="">
                          ...
                          {" "}
                          <button type="button" data-step="1" aria-label="One more RateGen seat">
                            +
                          </button>
                          {" "}
                        </span>
                      ...
                      <div data-line="heron">
                        ...
                        <span className="dsh-step">
                          {" "}
                          <button type="button" data-step="-1" aria-label="One fewer HERON seat">
                            −
                          </button>
                          {" "}
                          <span className="n" data-line-n="">
                          ...
                          {" "}
                          <button type="button" data-step="1" aria-label="One more HERON seat">
                            +
                          </button>
                          {" "}
                        </span>
                      ...
                      {" "}
                      <div style={{ borderTop: "1px solid var(--line-2)", paddingTop: "15px" }}>
                        {" "}
                        <span style={{ color: "var(--ink)", fontWeight: "400" }}>
                          Total due
                        </span>
                        {" "}
                        <b style={{ fontSize: "17px" }} data-total="">
                          ₦137,600
                        </b>
                      </div>
                      {" "}
                    ...
                    {" "}
                    <p style={{ margin: "16px 0 0", fontSize: "12.5px", fontWeight: "300", color: "var(--ink-3)", lineHeight: "1.6" }}>
                      {" "}Changing a seat count here takes effect at the next renewal, and is pro-rated if you add one mid-month. Removing a seat does not sign anyone out until the period ends.
                    </p>
                    {" "}
                    ...
                    <table className="tbl">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="#" data-fb-dl="" style={{ color: "var(--action)", fontSize: "12.5px", textDecoration: "none" }}>
                              PDF
                            </a>
                          </td>
                        </tr>
              ...
              <div>
                ...
                <div className="dsh-hub" id="yearly">
                  ...
                  <p>
                    ...
                    {" "}becomes{" "}
                    <b data-year-now="" style={{ fontWeight: "500", color: "#fff" }}>
                      ₦1,280,000
                    </b>
                    {" "}before VAT, a{" "}
                    <b data-save="" style={{ fontWeight: "500", color: "#fff" }}>
                      ₦256,000
                    </b>
                    {" "}saving.
                  </p>
                  {" "}
                  <button type="button" className="ds-btn btn-p ds-btn-sm" data-c="yearly">
                    Switch to yearly
                  </button>
                  {" "}
                  <p className="meta">
                    <span data-cycle-word="">
                      Billed monthly
                    </span>
                ...
                {" "}
                <section className="dsh-panel" style={{ marginTop: "20px" }}>
                  {" "}
                  <div className="dsh-ph">
                    <h2>
                      Payment method
                  ...
                  <div className="dsh-body">
                    ...
                    {" "}
                    <a className="ds-btn btn-o ds-btn-sm btn-full" href="#" data-fb-toast="info|Opening Paystack|You update the card on Paystack’s page, then come straight back here. We never see the card number." style={{ marginTop: "16px" }}>
                      Update the card
                    </a>
                    {" "}
                  </div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    ...
                    {" "}
                    <Link className="ds-btn btn-o ds-btn-sm btn-full" to="/manage/settings" data-ds-page="dash-settings" style={{ marginTop: "16px" }}>
                      Edit details
                    </Link>
                    {" "}
                    <p style={{ margin: "14px 0 0", fontSize: "12.5px", fontWeight: "300", color: "var(--ink-3)", lineHeight: "1.6" }}>
                      {" "}Add a TIN and it appears on every future invoice. Past invoices are not reissued.
                    </p>
                    {" "}
                  </div>
                  {" "}
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    {" "}
                    <p style={{ margin: "0", fontSize: "13px", fontWeight: "300", color: "var(--ink-3)", lineHeight: "1.65" }}>
                      {" "}Licences run to the end of the period you have paid for. Your rate library and project data stay in the account whether or not a licence is active.
                    </p>
                    {" "}
                    <button type="button" className="ds-btn btn-o ds-btn-sm btn-full" data-modal="contact" style={{ marginTop: "16px" }}>
                      Talk to us first
                    </button>
                    {" "}
                  </div>
