...
// Ported from RichardEnoch/adlm-studio-site src/admin-marketing.html
...
export default function DsAdminMarketing() {
  return (
    <>
      {/* bar Marketing | Content */}
      {" "}
      <div className="adm-shell" data-screen="marketing">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/marketing" className="on" aria-current="page" data-tip="Marketing">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-info" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    The things on the website that change often: testimonials and company logos, free resources, and the flyers.
                  </p>
                  {" "}
                </div>
                {" "}
