...
// Ported from RichardEnoch/adlm-studio-site src/admin-purchases.html
...
export default function DsAdminPurchases() {
  return (
    <>
      ...
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/purchases" className="on" aria-current="page" data-tip="Purchases">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-card" />
                </svg>
                <span className="lb">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/documents" data-tip="Composer">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-doc" />
                </svg>
                <span className="lb">
        ...
        <div className="adm-body">
          ...
          <main className="adm-page adm-scroll">
            ...
            <div className="adm-page-in">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Transfers awaiting verification. Somebody paid into the bank and uploaded a proof, so somebody here has to look at it. Card and USSD never appear on this screen, the gateway confirms those and they activate themselves.
                  </p>
                  {" "}
                </div>
                {" "}
              ...
              {" "}
              <div className="adm-tabs" id="adm-tabs" role="tablist">
              </div>
              {" "}
              <div className="adm-bulk" id="adm-bulk" hidden={true}>
                {" "}
                <span id="adm-bulk-n">
                </span>
                {" "}
                <div className="adm-bulk-acts">
                  {" "}
                  <button type="button" className="adm-b" data-bulk="clear">
                    Clear
                  </button>
                  {" "}
                  <button type="button" className="adm-b" data-bulk="reject">
                    Reject selected
                  </button>
                  {" "}
                  <button type="button" className="adm-b pri" data-bulk="approve">
                    Approve selected
                  </button>
                  {" "}
                </div>
              ...
              <p className="adm-foot-note">
                Approving grants the licences for the term the customer actually bought. The order carries it, so there is nothing to choose here and nothing to get wrong. Every approval and rejection is written against your name.
              </p>
              {" "}
            </div>
            {" "}
      ...
      {" "}
      <div className="adm-toast" id="adm-toast" role="status" aria-live="polite" hidden={true}>
      </div>
    </>
  );
}
