...
// Ported from RichardEnoch/adlm-studio-site src/dash-guides.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashGuides() {
  return (
    <>
      <div className="dsh">
        {" "}
          ...
          <div className="dsh-in">
            ...
            <div className="dsh-head">
              ...
              <div>
                ...
                {" "}
                <p>
                  The user guides for every ADLM product, written for people doing the work. Read one here or keep a copy. They are the same files the tutors teach from.
                </p>
                {" "}
              </div>
              {" "}
              <div className="dsh-acts">
                {" "}
                <a className="ds-btn btn-p ds-btn-sm" href="/docs/ADLM-Complete-User-Guide.pdf" download="" data-fb-toast="success|Download started|The complete user guide · 5.3 MB">
                  Download everything
                </a>
                {" "}
              </div>
                  ...
                  <div className="dsh-body">
                    ...
                    <div className="dsh-dl">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          All products · PDF · 48 pages · 5.3 MB
                        </span>
                        <p className="gd-d">
                          Every product in one file: the Installer Hub, QUIV, RateGen and HERON, in the order a project uses them.
                        </p>
                      </div>
                      {" "}
                      <div className="gd-a">
                        {" "}
                        <button type="button" className="ds-btn btn-o ds-btn-sm" data-doc="/docs/ADLM-Complete-User-Guide.pdf" data-title="The complete user guide">
                          Read
                        </button>
                        {" "}
                        <a className="ds-btn btn-p ds-btn-sm" href="/docs/ADLM-Complete-User-Guide.pdf" download="" data-fb-toast="success|Download started|The complete user guide · 5.3 MB">
                    ...
                    <div className="dsh-dl">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          Start here · PDF · 21 pages · 2.5 MB
                        </span>
                        <p className="gd-d">
                      ...
                      <div className="gd-a">
                        ...
                        {" "}
                        <a className="ds-btn btn-p ds-btn-sm" href="/docs/ADLM-Installer-Hub-User-Guide.pdf" download="" data-fb-toast="success|Download started|Installer Hub · 2.5 MB">
                          Download
                        </a>
                        {" "}
                      </div>
                    ...
                    <div className="dsh-dl">
                      ...
                      <div className="gd-a">
                        ...
                        {" "}
                        <a className="ds-btn btn-p ds-btn-sm" href="/docs/ADLM-QUIV-Revit-User-Guide.pdf" download="" data-fb-toast="success|Download started|QUIV for Revit · 2.5 MB">
                          Download
                        </a>
                        {" "}
                      </div>
                    ...
                    <div className="dsh-dl">
                      ...
                      <div className="gd-a">
                        ...
                        {" "}
                        <a className="ds-btn btn-p ds-btn-sm" href="/docs/ADLM-RateGen-User-Guide.pdf" download="" data-fb-toast="success|Download started|ADLM RateGen · 1.8 MB">
                          Download
                        </a>
                        {" "}
                      </div>
              ...
              <div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    {" "}
                    <p className="gd-p">
                      Ada answers from these guides and your own account, and says where in the guide the answer is. If she cannot help, a person on support will.
                    </p>
                    {" "}
                    <div className="gd-a" style={{ marginTop: "14px" }}>
                      {" "}
                      <button type="button" className="ds-btn btn-o ds-btn-sm" data-ada-open="">
                        Ask Ada
                      </button>
                      {" "}
                      <Link className="ds-btn btn-o ds-btn-sm" to="/manage/support" data-ds-page="dash-support">
                        Contact support
                      </Link>
                      {" "}
                    </div>
