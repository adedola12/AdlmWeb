...
// Ported from RichardEnoch/adlm-studio-site src/work-library.html
          ...
          <div className="dsh-in">
            ...
            <div className="wk-head">
              ...
              <div>
                ...
                {" "}
                <p>
                  One engine for the practice. Rates in your library, and every rate made inside a project: listed with the project beside it, and opening back inside that project.
                </p>
                {" "}
              </div>
              {" "}
              <div className="wk-acts">
                {" "}
                <div className="wk-loc-sw" data-loc-switch="" aria-label="Price the library for a location">
                </div>
                {" "}
            ...
            <div className="wk-bar">
              ...
              {" "}
              <div className="wk-dd" id="lib-origin">
              </div>
              {" "}
              <div className="wk-dd" id="lib-cat">
              </div>
              {" "}
              <div className="wk-dd" id="lib-sort">
              </div>
              {" "}
            </div>
            {" "}
            <div className="rg-only" id="rg-only">
            </div>
            {" "}
            <p className="wk-count" id="lib-count">
            </p>
            {" "}
            <div id="lib-rates">
            </div>
