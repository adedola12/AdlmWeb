...
// Ported from RichardEnoch/adlm-studio-site src/admin-people.html
      ...
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/people" className="on" aria-current="page" data-tip="People">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-team" />
                </svg>
                <span className="lb">
          ...
          <main className="adm-page adm-scroll">
            ...
            <div className="adm-page-in">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Every person with an ADLM account. Search by email, name or firm. It is the first thing anybody does on a support call, and open one to see everything that has happened to them.
                  </p>
                  {" "}
                </div>
                {" "}
              ...
              <label className="adm-find adm-find-wide">
                ...
                {" "}
                <input type="search" id="adm-q" placeholder="Search name, email or organisation" aria-label="Search people" />
                {" "}
              </label>
              {" "}
