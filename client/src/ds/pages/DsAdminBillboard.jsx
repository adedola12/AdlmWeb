...
// Ported from RichardEnoch/adlm-studio-site src/admin-billboard.html
...
export default function DsAdminBillboard() {
  return (
    <>
      {/* bar Billboard | Marketing */}
      {" "}
      <div className="adm-shell" data-screen="billboard">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/billboard" className="on" aria-current="page" data-tip="Billboard">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-computer" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    The band that rotates low on every page of the public site. A slide runs between the dates you give it and stops on its own, so nothing here has to be taken down by hand. Order is the order it rotates in.
                  </p>
                  {" "}
                </div>
                {" "}
