...
// Ported from RichardEnoch/adlm-studio-site src/admin-account.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminAccount() {
  return (
    <>
      {/* bar Account | Accounts */}
      {" "}
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/people" className="on within" data-tip="People">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-team" />
                </svg>
                <span className="lb">
        ...
        <div className="adm-body">
          ...
          <main className="adm-page adm-scroll">
            ...
            <div className="adm-page-in">
              {" "}
              <Link className="adm-back" to="/admin/people">
                {" "}
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-right" />
                </svg>
