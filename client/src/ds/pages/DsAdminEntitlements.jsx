...
// Ported from RichardEnoch/adlm-studio-site src/admin-entitlements.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminEntitlements() {
  return (
    <>
      {/* bar Entitlements | Commerce */}
      {" "}
      <div className="adm-shell" data-screen="entitlements">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/entitlements" className="on" aria-current="page" data-tip="Entitlements">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-plus" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Features switched on for a particular account for a set time, BoQ Import being the one that exists. Eligibility depends on holding something else, so a grant pauses itself when the subscription behind it lapses and resumes if they renew. Nobody has to remember.
                  </p>
                  {" "}
                </div>
                {" "}
