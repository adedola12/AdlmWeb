...
// Ported from RichardEnoch/adlm-studio-site src/admin-whats-new.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminWhatsNew() {
  return (
    <>
      {/* bar What's New | Content */}
      {" "}
      <div className="adm-shell" data-screen="whatsnew">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/whats-new" className="on" aria-current="page" data-tip="What's New">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-alert" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Every release across every product, newest first &mdash; which is exactly how a visitor reads the public page. A note written here appears on{" "}
                    <code>
                      /whats-new
                    </code>
                    {" "}and on that product&rsquo;s own page, because there is one list seen two ways.
                  </p>
                  {" "}
                </div>
                {" "}
