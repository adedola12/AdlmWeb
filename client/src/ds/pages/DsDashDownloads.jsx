...
// Ported from RichardEnoch/adlm-studio-site src/dash-downloads.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashDownloads() {
  return (
    <>
      <div className="dsh">
        {" "}
          ...
          <div className="dsh-in">
            ...
            <div className="dsh-head">
              ...
              <div className="dsh-acts">
                {" "}
                <a className="ds-btn btn-p ds-btn-sm" href="#" data-fb-dl="ADLM Installer Hub for Windows">
            ...
            {" "}
            <div className="dsh-hub" style={{ marginBottom: "20px" }}>
              {" "}
              <h3>
                Installer Hub v1.0
              </h3>
              {" "}
              <p>
                One signed-in app that installs and updates everything the practice owns, shows what the subscription covers, and gets you help when something goes wrong.
              </p>
              {" "}
              <a className="ds-btn btn-p ds-btn-sm" href="#" data-fb-dl="ADLM Installer Hub for Windows">
              ...
              {" "}
              <p className="meta">
                Windows 64-bit · 84 MB · released July 2026 · requires an ADLM account
              </p>
              {" "}
            </div>
            {" "}
              ...
              <div>
                  ...
                  <div className="dsh-body">
                    ...
                    <div className="dsh-dl">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          Revit 2021–2026 · 62 MB · 31 July 2026 · installed
                        </span>
                      </div>
                      {" "}
                      <a className="ds-btn btn-o ds-btn-sm" href="#" data-fb-dl="">
                        Installer
                      </a>
                      {" "}
                    </div>
                    ...
                    <div className="dsh-dl">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          Windows 64-bit · 48 MB · July 2026 · installed
                        </span>
                      </div>
                      {" "}
                      <a className="ds-btn btn-o ds-btn-sm" href="#" data-fb-dl="">
                    ...
                    <div className="dsh-dl">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          Windows 64-bit · 55 MB · 31 July 2026 · v2.9.0 installed
                        </span>
                      </div>
                      {" "}
                      <a className="ds-btn btn-p ds-btn-sm" href="#" data-fb-dl="">
                        Update
                      </a>
                      {" "}
                    </div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-ph">
                    ...
                    {" "}
                    <button type="button" className="more" data-modal="pricing">
                      See pricing
                    </button>
                  </div>
                  {" "}
                  <div className="dsh-body">
                    ...
                    <div className="dsh-dl">
                      {" "}
                      <img src="/ds/ic-mep.png" alt="" style={{ filter: "grayscale(1)", opacity: ".5" }} />
                      {" "}
                      <div className="nm">
                        <b>
                          Revit MEP v1.8.3
                      ...
                      {" "}
                      <Link className="ds-btn btn-o ds-btn-sm" to="/product/mep" data-ds-page="dash-product">
                        Details
                      </Link>
                      {" "}
                    </div>
                    ...
                    <div className="dsh-dl">
                      {" "}
                      <img src="/ds/ic-timepro.png" alt="" style={{ filter: "grayscale(1)", opacity: ".5" }} />
                      {" "}
                      <div className="nm">
                        <b>
                          Time Pro v1.1.0
                      ...
                      {" "}
                      <Link className="ds-btn btn-o ds-btn-sm" to="/product/qs-takeoff" data-ds-page="dash-product">
                        Details
                      </Link>
                      {" "}
                    </div>
              ...
              <div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-ph">
                    ...
                    {" "}
                    <Link className="more" to="/manage/guides" data-ds-page="dash-guides">
                      Guides &amp; docs
                    </Link>
                  </div>
                  {" "}
                  <div className="dsh-body">
                    {" "}
                    <p style={{ margin: "0", fontSize: "13px", fontWeight: "300", color: "var(--ink-2)", lineHeight: "1.6" }}>
                      The guides for QUIV, RateGen and the Installer Hub live under Learn, where you can read them in the browser as well as download them.
                    </p>
                    {" "}
                  </div>
                  {" "}
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    {" "}
                    <div data-acc="" className="open" style={{ borderBottom: "1px solid var(--line)", padding: "13px 0" }}>
                      {" "}
                      <button type="button" data-acc-h="">
                        <svg viewBox="0 0 24 24" style={{ width: "15px", height: "15px", flex: "none", fill: "none", stroke: "var(--pal-light-key)", strokeWidth: "2.2", strokeLinecap: "round", strokeLinejoin: "round" }}>
                          <use href="#hi-check" />
                        </svg>
                        <span style={{ fontSize: "13px", color: "var(--ink)" }}>
                          Close Revit or PlanSwift first
                        </span>
                    ...
                    {" "}
                    <div data-acc="" style={{ borderBottom: "1px solid var(--line)", padding: "13px 0" }}>
                      {" "}
                      <button type="button" data-acc-h="">
                        <svg viewBox="0 0 24 24" style={{ width: "15px", height: "15px", flex: "none", fill: "none", stroke: "var(--pal-light-key)", strokeWidth: "2.2", strokeLinecap: "round", strokeLinejoin: "round" }}>
                          <use href="#hi-check" />
                        ...
                        <span style={{ fontSize: "13px", color: "var(--ink)" }}>
                          A seat activates against this machine, not this person
                        </span>
                        <svg className="acc-car" viewBox="0 0 24 24">
                          <use href="#hi-chevron" />
                        </svg>
                      ...
                      <div className="acc-body">
                        <div>
                          <p style={{ paddingLeft: "27px", marginTop: "10px" }}>
                            Signing in on a second machine takes a second activation. This account has three still free.
                          </p>
                        </div>
                      </div>
                      {" "}
                    ...
                    <div data-acc="" style={{ borderBottom: "1px solid var(--line)", padding: "13px 0" }}>
                      ...
                      <button type="button" data-acc-h="">
                        ...
                        <span style={{ fontSize: "13px", color: "var(--ink)" }}>
                          Moving a seat is done here, not by reinstalling
                        </span>
                        <svg className="acc-car" viewBox="0 0 24 24">
                          <use href="#hi-chevron" />
                        </svg>
                      ...
                      <div className="acc-body">
                        <div>
                          <p style={{ paddingLeft: "27px", marginTop: "10px" }}>
                            Free the seat under Team & seats, then install on the new machine. Reinstalling without freeing it uses up an activation that then has to be released by support.
                          </p>
                        </div>
                      </div>
                      {" "}
                    ...
                    <div data-acc="" style={{ borderBottom: "1px solid var(--line)", padding: "13px 0" }}>
                      ...
                      <div className="acc-body">
                        <div>
                          <p style={{ paddingLeft: "27px", marginTop: "10px" }}>
                            Revit and PlanSwift are Windows-only, so the plugins follow. The mobile app covers iOS and Android and needs no seat.
                          </p>
                        </div>
                      </div>
                      {" "}
