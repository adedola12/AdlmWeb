...
// Ported from RichardEnoch/adlm-studio-site src/dash-support.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashSupport() {
  return (
    <>
      <div className="dsh">
        {" "}
          ...
          <div className="dsh-in">
            ...
            <div className="dsh-head">
              ...
              <div>
                ...
                {" "}
                <p>
                  A ticket opened here already carries your licences, versions and machines, so nobody has to ask you for them first. Replies come from a real address, usually the same working day.
                </p>
                {" "}
              </div>
              {" "}
              <div className="dsh-acts">
                {" "}
                <a className="ds-btn btn-o ds-btn-sm" href="https://wa.me/2348106503524" target="_blank" rel="noopener">
                  WhatsApp
                </a>
                {" "}
              ...
              <div>
                ...
                <section className="dsh-panel" id="ticket">
                  ...
                  <div className="dsh-body">
                    {" "}
                    <form data-fb="ticket" className="dsh-form" action="/manage/support" method="get" style={{ maxWidth: "none" }}>
                      {" "}
                      <div className="two">
                        {" "}
                        <div className="ds-field">
                          <label htmlFor="tk-prod">
                            Which product
                          </label>
                          {" "}
                      ...
                      {" "}
                      <div className="ds-field">
                        <label htmlFor="tk-sub">
                          Summary
                        </label>
                        {" "}
                        <input id="tk-sub" name="subject" type="text" placeholder="The Revit panel does not appear after installing" required={true} />
                      </div>
                      {" "}
                      <div className="ds-field">
                        <label htmlFor="tk-msg">
                          What happens, and what you expected
                        </label>
                        {" "}
                        <textarea id="tk-msg" name="message" rows="5" placeholder="Steps, the exact message if there is one, and when it started." required={true}>
                        </textarea>
                      </div>
                      {" "}
                      <div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    ...
                    <div data-acc="">
                      {" "}
                      <div className="dsh-tkt" data-acc-h="" role="button" tabIndex="0">
                        {" "}
                        <span className="ref">
                          ADLM-4482
                        </span>
                        {" "}
                        <div className="nm">
                          Revit panel missing after a manual install{" "}
                          <span>
                            QUIV v3.1.6 · TUNDE-WS02 · opened 28 July
                          </span>
                        </div>
                        {" "}
                      ...
                      <div className="acc-body">
                        <div>
                          <p>
                            Reinstalled through the Installer Hub rather than the standalone file. The Hub registers the Revit panel on install; the manual installer had not. The panel appeared on the next launch of Revit 2025. Closed 29 July.
                          </p>
                        </div>
                      </div>
                      {" "}
                    ...
                    <div data-acc="">
                      ...
                      <div className="dsh-tkt" data-acc-h="" role="button" tabIndex="0">
                        ...
                        {" "}
                        <div className="nm">
                          Rate library not syncing to a second machine{" "}
                          <span>
                            RateGen v2.4.2 · CHIDI-LT01 · opened 3 July
                          </span>
                        </div>
                        {" "}
                        <span className="pill pill-a">
                    ...
                    <div data-acc="" className="open">
                      ...
                      <div className="dsh-tkt" data-acc-h="" role="button" tabIndex="0">
                        ...
                        {" "}
                        <div className="nm">
                          Invoice needs our TIN on it{" "}
                          <span>
                            Billing · opened 11 August
                          </span>
                        </div>
                        {" "}
                      ...
                      <div className="acc-body">
                        <div>
                          <p>
                            Waiting on your TIN. Add it under Account settings and every invoice issued after that carries it. The four already issued are not reissued.
                          </p>
                        </div>
                      </div>
                      {" "}
              ...
              <div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-ph">
                    ...
                    {" "}
                    <button type="button" className="more" data-modal="licensing">
                      Licensing
                    </button>
                  </div>
                  {" "}
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    ...
                    <p style={{ margin: "0", fontSize: "13px", fontWeight: "300", color: "var(--ink-3)", lineHeight: "1.65" }}>
                      {" "}If the same question keeps coming up across the practice, it is usually a training problem rather than a support one. On-site sessions run on your own projects.
                    </p>
                    {" "}
                    <button type="button" className="ds-btn btn-o ds-btn-sm btn-full" data-modal="training" style={{ marginTop: "16px" }}>
                      Training for firms
                    </button>
                    {" "}
                  </div>
