...
// Ported from RichardEnoch/adlm-studio-site src/admin-support.html
...
export default function DsAdminSupport() {
  return (
    <>
      {/* bar Support | Accounts */}
      {" "}
      <div className="adm-shell" data-screen="support">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/support" className="on" aria-current="page" data-tip="Support">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-support" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    One queue with two reasons to be in it: somebody asked for help, or an order needs chasing. Every ticket is attached to the account it belongs to, so whoever answers can see what that customer holds without leaving the ticket.
                  </p>
                  {" "}
                </div>
                {" "}
