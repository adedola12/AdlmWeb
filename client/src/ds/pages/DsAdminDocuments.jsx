...
// Ported from RichardEnoch/adlm-studio-site src/admin-documents.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminDocuments() {
  return (
    <>
      {/* bar Document composer | Documents */}
      {" "}
      <div className="adm-shell">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" style={{ display: "none" }} aria-hidden="true">
          {" "}
          <symbol id="ai-org" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M3 20.5h18" />
            <path d="M5 20.5V6.2a1.2 1.2 0 0 1 .8-1.13l6-2.1a1.2 1.2 0 0 1 1.6 1.13V20.5" />
            <path d="M13.4 20.5V9.6h4.4a1.2 1.2 0 0 1 1.2 1.2v9.7" />
            <path d="M8 8h2M8 11.5h2M8 15h2" />
          </symbol>
          {" "}
          <symbol id="ai-quote" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M5.5 3.5h9L19 8v12.5H5.5V3.5Z" />
            <path d="M14 3.5V8h5" />
            <path d="M8.6 12.4h6M8.6 15.6h4" />
          </symbol>
          {" "}
          <symbol id="ai-tag" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M20.2 12.6 12.7 20a1.8 1.8 0 0 1-2.6 0l-6.3-6.3a1.8 1.8 0 0 1-.5-1.4l.4-6.1a1.8 1.8 0 0 1 1.7-1.7l6.1-.4a1.8 1.8 0 0 1 1.4.5l7.3 7.3a1.6 1.6 0 0 1 0 2.7Z" />
            <path d="M8.7 8.7h.01" />
          </symbol>
          {" "}
          <symbol id="ai-mail" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M3.5 6.8A2.3 2.3 0 0 1 5.8 4.5h12.4a2.3 2.3 0 0 1 2.3 2.3v10.4a2.3 2.3 0 0 1-2.3 2.3H5.8a2.3 2.3 0 0 1-2.3-2.3V6.8Z" />
            <path d="m4.2 6.4 6.5 5a2 2 0 0 0 2.6 0l6.5-5" />
          </symbol>
          {" "}
          <symbol id="ai-ada" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 3.6l1.4 4.1c.3.87.45 1.3.74 1.63.14.16.31.3.49.42.37.25.82.34 1.73.53L20 11l-3.62.75c-.91.19-1.36.28-1.73.53-.18.12-.35.26-.49.42-.29.33-.44.76-.74 1.63L12 18.4l-1.42-4.1c-.3-.87-.45-1.3-.74-1.63a2.2 2.2 0 0 0-.49-.42c-.37-.25-.82-.34-1.73-.53L4 11l3.62-.72c.91-.19 1.36-.28 1.73-.53.18-.12.35-.26.49-.42.29-.33.44-.76.74-1.63L12 3.6Z" />
            <path d="M18.4 17.2l.4 1.1 1.2.25-1.2.25-.4 1.1-.4-1.1-1.2-.25 1.2-.25.4-1.1Z" />
          </symbol>
          {" "}
        </svg>
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          {" "}
          <button type="button" className="adm-tog" data-adm-tog="" aria-label="Collapse the navigation">
            {" "}
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/purchases" data-tip="Purchases">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-card" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/installations" data-tip="Installations">
                <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            {" "}
            <li>
              <Link to="/admin/enrolments" data-tip="Enrolments">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-calendar" />
                </svg>
                <span className="lb">
                  Enrolments
                </span>
            ...
            {" "}
            <li>
              <Link to="/admin/submissions" data-tip="Submissions">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-check" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/ada" data-tip="Ada review">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-ada" />
                </svg>
                <span className="lb">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/organisations" data-tip="Organisations">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-org" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/people" data-tip="People">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-team" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/support" data-tip="Support">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-support" />
                </svg>
                <span className="lb">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/subscriptions" data-tip="Subscriptions">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-shield" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/entitlements" data-tip="Entitlements">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-plus" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/quotations" data-tip="Quotations">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-quote" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/invoices" data-tip="Invoices">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-billing" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/coupons" data-tip="Coupons">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-tag" />
                </svg>
                <span className="lb">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/products" data-tip="Products">
                <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            {" "}
            <li>
              <Link to="/admin/pricing" data-tip="Price book">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-doc" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/rates" data-tip="Rate data">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#wi-library" />
                </svg>
                <span className="lb">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/courses" data-tip="Courses">
                <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            {" "}
            <li>
              <Link to="/admin/events" data-tip="Events">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-play" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/certificates" data-tip="Certificates">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-cert" />
                </svg>
                <span className="lb">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/whats-new" data-tip="What's New">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-alert" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/marketing" data-tip="Marketing">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-info" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/emails" data-tip="Emails">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-mail" />
                </svg>
                <span className="lb">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/documents" className="on" aria-current="page" data-tip="Composer">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-doc" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/templates" data-tip="Templates">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#wi-library" />
                </svg>
                <span className="lb">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/ai" data-tip="AI usage">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-ada" />
                </svg>
                <span className="lb">
            ...
            {" "}
            <li>
              <Link to="/admin/system" data-tip="System">
                <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        {" "}
        <div className="adm-veil" data-adm-close="">
        </div>
        {" "}
        <div className="adm-body">
          ...
          <header className="adm-top">
            {" "}
            <button type="button" className="adm-ico adm-burger" data-adm-open="" aria-label="Open the navigation">
              {" "}
              <svg viewBox="0 0 24 24" aria-hidden="true">
                <use href="#hi-menu" />
              </svg>
            ...
            <label className="adm-find">
              ...
              {" "}
              <input type="search" placeholder="Search accounts, orders, documents" aria-label="Search" />
              {" "}
              <kbd>
                &#8984;K
              </kbd>
            ...
            {" "}
            <button className="tt adm-ico" id="tt" type="button" aria-label="Switch colour theme">
              {" "}
            ...
            {" "}
            <button type="button" className="adm-me">
              {" "}
              <span className="avi">
                RE
              </span>
          ...
          <div className="adm">
            {" "}
            <aside className="adm-side doc-noprint">
              {" "}
              ...
              {" "}
              <div className="adm-seg" id="adm-brand" role="group" aria-label="Whose paper">
                {" "}
                <button type="button" className="on" data-brand="adlm">
                  ADLM
                </button>
                {" "}
              ...
              <p className="adm-hint">
                ADLM documents carry our mark and colour. A practice's carry theirs, with one line of credit in the footer, never our letterhead on their professional work.
              </p>
              {" "}
              <div className="adm-grp">
                Template
              ...
              {" "}
              <div className="adm-tpls" id="adm-tpl">
              </div>
              {" "}
              <div className="adm-grp">
                The document
              ...
              <div className="adm-fields">
                ...
                <label>
                  Title
                  <input id="adm-title" type="text" placeholder="Proposal" />
                </label>
                {" "}
                <label>
                  Number
                  <input id="adm-number" type="text" placeholder="Leave blank for none" />
                </label>
                {" "}
                <label>
                  Date
                ...
                <label>
                  ...
                  <textarea id="adm-meta" rows="3" placeholder="One line each">
                  </textarea>
                </label>
                {" "}
              </div>
              ...
              {" "}
              <div className="adm-kept" id="adm-kept" hidden={true}>
              </div>
              {" "}
              <p className="adm-hint">
                Drafts are kept in this browser only. There is no admin account behind this screen yet. That is the next thing to design.
              </p>
              {" "}
            </aside>
            {" "}
            <main className="adm-main">
              {" "}
              <header className="adm-bar doc-noprint">
                {" "}
                <div>
                  {" "}
                  <b>
                ...
                <div className="adm-acts">
                  {" "}
                  <button type="button" className="ds-btn btn-o ds-btn-sm" data-adm-pane="">
                    Hide source
                  </button>
                  {" "}
                  <button type="button" className="ds-btn btn-o ds-btn-sm" id="adm-clear">
                    Clear
                  </button>
                  {" "}
              ...
              <div className="adm-split">
                {" "}
                <section className="adm-src doc-noprint" id="adm-drop">
                  {" "}
                  <h3>
                    What goes in
                  </h3>
                  ...
                  <div className="adm-file">
                    {" "}
                    <button type="button" className="ds-btn btn-o ds-btn-sm" id="adm-pick">
                      Choose a file
                    </button>
                    {" "}
                  ...
                  {" "}
                  <p className="adm-note" id="adm-file-note" hidden={true}>
                  </p>
                  {" "}
                  <textarea id="adm-text" spellCheck="false" aria-label="The text to format">
                  </textarea>
                  {" "}
                  <div className="adm-src-foot">
                    {" "}
                    <button type="button" className="ds-btn btn-p ds-btn-sm" id="adm-build">
                      Format it
                    </button>
                    {" "}
                    <span className="adm-kbd">
                      or{" "}
                      <kbd>
                        Ctrl
                      </kbd>
                  ...
                  <details className="adm-rules">
                    ...
                    <ul>
                      ...
                      <li>
                        <b>
                          A SHORT LINE IN CAPITALS
                        </b>
                        {" "}becomes a section heading too, most people type a heading that way rather than in Markdown.
                      </li>
                      {" "}
                      <li>
                        <b>
                        ...
                        {" "}starting with a dash, bullet or asterisk becomes a bullet.
                      </li>
                      {" "}
                      <li>
                        Lines with{" "}
                        ...
                        {" "}become a table, first row as the header. A single such line is left as text, one row is not a table.
                      </li>
                      {" "}
                      <li>
