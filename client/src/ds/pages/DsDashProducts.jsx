...
// Ported from RichardEnoch/adlm-studio-site src/dash-products.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashProducts() {
  return (
    <>
      <div className="dsh">
        {" "}
          ...
          <div className="dsh-in">
            ...
            <div className="dsh-head">
              ...
              <div className="dsh-acts">
                {" "}
                <button type="button" className="ds-btn btn-o ds-btn-sm" data-modal="pricing">
                  See pricing
                </button>
                {" "}
                <button type="button" className="ds-btn btn-p ds-btn-sm" data-modal="contact">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "14px", marginBottom: "20px", flexWrap: "wrap" }}>
              {" "}
              <div className="dsh-seg" data-seg="#prodgrid" data-seg-count="#prodcount">
                {" "}
                <button type="button" data-f="all" className="on">
                  All seven
                </button>
                {" "}
                <button type="button" data-f="sub">
                  Covered by the account
                </button>
                {" "}
                <button type="button" data-f="avail">
                  Available to add
                </button>
                {" "}
              </div>
              {" "}
              <span id="prodcount" style={{ fontSize: "12.5px", color: "var(--ink-3)" }}>
                7 items
              </span>
              {" "}
            </div>
            {" "}
            <div className="dsh-grid" id="prodgrid">
              {" "}
              <article className="dsh-card" data-cat="sub">
                {" "}
                <div className="top">
                  {" "}
                  <img className="picon" src="/ds/ic-quiv.png" alt="" />
                  {" "}
                  <div>
                    <h3>
                      QUIV
                ...
                <div className="foot2">
                  {" "}
                  <Link className="ds-btn btn-o ds-btn-sm" to="/product/revit" data-ds-page="dash-product">
                    Manage
                  </Link>
                  {" "}
                  <Link className="ds-btn btn-o ds-btn-sm" to="/manage/team" data-ds-page="dash-team">
                    Seats
                  </Link>
                  {" "}
                </div>
              ...
              <article className="dsh-card" data-cat="sub">
                ...
                <div className="top">
                  {" "}
                  <img className="picon" src="/ds/ic-rategen.png" alt="" />
                  {" "}
                  <div>
                    <h3>
                      RateGen
                ...
                {" "}
                <p>
                  The practice rate library. One set of build-ups, priced to location, syncing to QUIV and HERON. One seat is still unassigned.
                </p>
                {" "}
                <div className="foot2">
                  {" "}
                  <Link className="ds-btn btn-o ds-btn-sm" to="/product/rategen" data-ds-page="dash-product">
                    Manage
                  </Link>
                  {" "}
                  <Link className="ds-btn btn-p ds-btn-sm" to="/manage/team" data-ds-page="dash-team">
                    Assign the spare seat
                  </Link>
                  {" "}
                </div>
                {" "}
              ...
              <article className="dsh-card" data-cat="sub">
                ...
                <div className="top">
                  {" "}
                  <img className="picon" src="/ds/ic-heron.png" alt="" />
                  {" "}
                  <div>
                    <h3>
                      HERON
                ...
                {" "}
                <p>
                  Takeoff from flat drawings and photographed sheets. Nobody holds the seat yet, so the update has nowhere to land.
                </p>
                {" "}
                <div className="foot2">
                  {" "}
                  <Link className="ds-btn btn-p ds-btn-sm" to="/manage/downloads" data-ds-page="dash-downloads">
                    Update
                  </Link>
                  {" "}
                  <Link className="ds-btn btn-o ds-btn-sm" to="/product/planswift" data-ds-page="dash-product">
                    Manage
                  </Link>
                  {" "}
                </div>
              ...
              {" "}
              <article className="dsh-card off" data-cat="avail">
                {" "}
                <div className="top">
                  {" "}
                  <img className="picon" src="/ds/ic-mep.png" alt="" />
                  {" "}
                  <div>
                    <h3>
                      Revit MEP
                ...
                <div className="foot2">
                  {" "}
                  <button type="button" className="ds-btn btn-o ds-btn-sm" data-modal="mep">
                    What it does
                  </button>
                  {" "}
                  <button type="button" className="ds-btn btn-p ds-btn-sm" data-modal="pricing">
                    Add to subscription
                  </button>
                  {" "}
                </div>
              ...
              <article className="dsh-card off" data-cat="avail">
                ...
                <div className="top">
                  {" "}
                  <img className="picon" src="/ds/ic-timepro.png" alt="" />
                  {" "}
                  <div>
                    <h3>
                      Time Pro
                ...
                {" "}
                <p>
                  Programmes, daily site records and MS Project exports. The piece that would connect your valuations to a date.
                </p>
                {" "}
                <div className="foot2">
                  {" "}
                  <button type="button" className="ds-btn btn-o ds-btn-sm" data-modal="timepro">
                    What it does
                  </button>
                  {" "}
                  <button type="button" className="ds-btn btn-p ds-btn-sm" data-modal="pricing">
              ...
              <article className="dsh-card off" data-cat="avail">
                ...
                <div className="top">
                  {" "}
                  <img className="picon" src="/ds/ic-civiq.png" alt="" />
                  {" "}
                  <div>
                    <h3>
                      CIVIQ
                ...
                <div className="foot2">
                  {" "}
                  <button type="button" className="ds-btn btn-o ds-btn-sm" data-modal="civiq">
                    Join the waitlist
                  </button>
                  {" "}
                </div>
              ...
              {" "}
              <article className="dsh-card off" data-cat="sub">
                {" "}
                <div className="top">
                  {" "}
                  <span className="ic" style={{ width: "42px", height: "42px", borderRadius: "13px", display: "grid", placeItems: "center", background: "var(--pal-light-wash)", flex: "none" }}>
                    {" "}
                    <svg viewBox="0 0 24 24" style={{ width: "20px", height: "20px", fill: "none", stroke: "var(--pal-light-key)", strokeWidth: "1.7" }}>
                      <use href="#hi-phone" />
                    </svg>
                    {" "}
                  </span>
                ...
                <div className="foot2">
                  {" "}
                  <button type="button" className="ds-btn btn-o ds-btn-sm" data-modal="mobile">
                    About the app
                  </button>
                  {" "}
                </div>
