...
// Ported from RichardEnoch/adlm-studio-site src/admin-organisations.html
      ...
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/organisations" className="on" aria-current="page" data-tip="Organisations">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-org" />
                </svg>
                <span className="lb">
