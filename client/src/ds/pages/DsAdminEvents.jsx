...
// Ported from RichardEnoch/adlm-studio-site src/admin-events.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminEvents() {
  return (
    <>
      {/* bar Events | Learning */}
      {" "}
      <div className="adm-shell" data-screen="events">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/events" className="on" aria-current="page" data-tip="Events">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-play" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Physical and live training: the dates, the venues, what a seat costs and how many are left. Seats are finite here, which is what the Enrolments queue checks against before it will approve anything.
                  </p>
                  {" "}
                </div>
                {" "}
