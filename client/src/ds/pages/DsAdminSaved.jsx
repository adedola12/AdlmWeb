...
// Ported from RichardEnoch/adlm-studio-site src/admin-saved.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminSaved() {
  return (
    <>
      {/* bar Saved | Documents */}
      {" "}
      <div className="adm-shell" data-screen="saved">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/saved" className="on" aria-current="page" data-tip="Saved documents">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-quote" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    What the composer has made and kept. Each one opens back into the composer exactly as it was &mdash; still editable, block by block &mdash; or can be previewed as paper, duplicated, or sent.
                  </p>
                  {" "}
                </div>
                {" "}
