...
// Ported from RichardEnoch/adlm-studio-site src/admin-products.html
...
export default function DsAdminProducts() {
  return (
    <>
      {/* bar Products | Catalogue */}
      {" "}
      <div className="adm-shell" data-screen="products">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/products" className="on" aria-current="page" data-tip="Products">
                <svg viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    The six products a subscription is sold against, each with what it costs, the storage it comes with, and its release notes. Editing a release note is what puts it on the public What’s New page.
                  </p>
                  {" "}
                </div>
                {" "}
