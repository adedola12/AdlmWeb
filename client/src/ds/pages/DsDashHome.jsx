              ...
              <div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-ph">
                    ...
                    {" "}
                    <Link className="more" to="/products" data-ds-page="dash-products">
                      All products
                    </Link>
                    {" "}
                  </div>
                  ...
                  <div className="dsh-body">
                    ...
                    <ul className="dsh-att">
                      ...
                      <li className="warn">
                        ...
                        {" "}
                        <Link className="act" to="/dashboard" data-ds-page="dash-downloads">
                          Update
                        </Link>
                        {" "}
                      ...
                      <li>
                        ...
                        {" "}
                        <Link className="act" to="/profile" data-ds-page="dash-team">
                          Assign
                        </Link>
                        {" "}
                        <button type="button" className="dsh-x" data-dismiss="#attn" aria-label="Clear this from the list">
                      ...
                      <li>
                        ...
                        {" "}
                        <Link className="act" to="/profile" data-ds-page="dash-billing">
                          Review
                        </Link>
                        {" "}
                        <button type="button" className="dsh-x" data-dismiss="#attn" aria-label="Clear this from the list">
