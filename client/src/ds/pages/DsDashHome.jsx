...
// Ported from RichardEnoch/adlm-studio-site src/dash-home.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashHome() {
  return (
    <>
      <div className="dsh">
        {" "}
          ...
          <div className="dsh-in">
            ...
            <div className="dsh-head">
              ...
              <div className="dsh-acts">
                {" "}
                <span className="when" data-today="">
            ...
            <div className="dsh-stats">
              ...
              <div className="dsh-stat">
                ...
                {" "}
                <p className="ds-sub">
                  Monthly · 7 September 2026
                </p>
                {" "}
              </div>
              {" "}
              <div className="dsh-stat warn">
                {" "}
                <span className="k">
                  <svg viewBox="0 0 24 24">
                    <use href="#hi-learning" />
            ...
            <div className="dsh-cols">
              ...
              <div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-ph">
                    ...
                    {" "}
                    <Link className="more" to="/manage/products" data-ds-page="dash-products">
                      All products
                    </Link>
                    {" "}
                  </div>
                  ...
                  <div className="dsh-body">
                    ...
                    <div className="dsh-prod">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          v3.1.7 · installed on 2 machines
                        </span>
                      </div>
                      {" "}
                    ...
                    <div className="dsh-prod">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          v2.5.0 · library synced 2 hours ago
                        </span>
                      </div>
                      {" "}
                      <span className="pill pill-a">
                    ...
                    <div className="dsh-prod">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          v2.9.0 installed · v2.9.1 available
                        </span>
                      </div>
                      {" "}
                    ...
                    <ul className="dsh-att">
                      ...
                      <li className="warn">
                        ...
                        <div>
                          {" "}
                          <b>
                            HERON v2.9.1 is waiting to install
                          </b>
                          {" "}
                          <p>
                            Sharper tracing on photographed sheets. The Hub will apply it to the one machine holding a HERON seat.
                          </p>
                          {" "}
                        </div>
                        {" "}
                        <Link className="act" to="/manage/downloads" data-ds-page="dash-downloads">
                          Update
                        </Link>
                        {" "}
                        <button type="button" className="dsh-x" data-dismiss="#attn" aria-label="Clear this from the list">
                          <svg viewBox="0 0 24 24">
                            <use href="#hi-close" />
                          </svg>
                        </button>
                      ...
                      <li>
                        ...
                        <div>
                          {" "}
                          <b>
                            A RateGen seat has been unassigned since 28 July
                          </b>
                          {" "}
                          <p>
                            You are paying for it. Assign it to Halima Yusuf or drop to four seats at the next renewal.
                          </p>
                          {" "}
                        </div>
                        {" "}
                        <Link className="act" to="/manage/team" data-ds-page="dash-team">
                          Assign
                        </Link>
                        {" "}
                        <button type="button" className="dsh-x" data-dismiss="#attn" aria-label="Clear this from the list">
                      ...
                      <li>
                        ...
                        <div>
                          {" "}
                          <b>
                            Invoice ADLM-2026-0731 is due on 7 September
                          </b>
                          {" "}
                          <p>
                            ₦137,600 including VAT, on the card ending 4417. Switching to yearly would make two months free.
                          </p>
                          {" "}
                        </div>
                        {" "}
                        <Link className="act" to="/manage/billing" data-ds-page="dash-billing">
                          Review
                        </Link>
                        {" "}
                        <button type="button" className="dsh-x" data-dismiss="#attn" aria-label="Clear this from the list">
                      ...
                      <li>
                        ...
                        <div>
                          {" "}
                          <b>
                            Rates &amp; 2D Takeoff has not been started
                          </b>
                          {" "}
                          <p>
                        ...
                        {" "}
                        <Link className="act" to="/dash-learning" data-ds-page="dash-learning">
                          Open
                        </Link>
                        {" "}
                        <button type="button" className="dsh-x" data-dismiss="#attn" aria-label="Clear this from the list">
              ...
              <div>
                ...
                <div className="dsh-hub">
                  ...
                  {" "}
                  <p>
                    The desktop app that installs and updates everything the practice owns. Sign in once and it keeps all five seats current.
                  </p>
                  {" "}
                  <Link className="ds-btn btn-p ds-btn-sm" to="/manage/downloads" data-ds-page="dash-downloads">
                  ...
                  {" "}
                  <p className="meta">
                    Windows 64-bit · 84 MB · released July 2026
                  </p>
                  {" "}
                </div>
                {" "}
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-ph">
                    ...
                    {" "}
                    <Link className="more" to="/dash-learning" data-ds-page="dash-learning">
                      All courses
                    </Link>
                    {" "}
                  </div>
                  ...
                  <div className="dsh-body">
                    ...
                    <div className="dsh-course">
                      ...
                      {" "}
                      <p>
                        Ifeoma finished the capstone and has her certificate. Two seats still on the course.
                      </p>
                      {" "}
                    </div>
                    {" "}
                    <div className="dsh-course">
                      ...
                      {" "}
                      <p>
                        Four weeks, ₦85,000 a year, one seat enrolled on 2 August.
                      </p>
                      {" "}
                    </div>
                    {" "}
