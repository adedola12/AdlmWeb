...
// Ported from RichardEnoch/adlm-studio-site src/admin-ai.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminAi() {
  return (
    <>
      {/* bar AI usage | System */}
      {" "}
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            {" "}
            <li>
              <Link to="/admin/ai" className="on" aria-current="page" data-tip="AI usage">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-ada" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Ada is the only thing in the studio that costs money per use, so it is the only line that can quietly run away. This leads with the credit rather than the spend, because the question is which runs out first &mdash; the money or the clock.
                  </p>
                  {" "}
                </div>
                {" "}
