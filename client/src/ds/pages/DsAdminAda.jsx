...
// Ported from RichardEnoch/adlm-studio-site src/admin-ada.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminAda() {
  return (
    <>
      {/* bar Ada review | Approvals */}
      {" "}
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/ada" className="on" aria-current="page" data-tip="Ada review">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-ada" />
                </svg>
                <span className="lb">
            ...
            <div className="adm-page-in">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Ada draws on everything ADLM publishes, so when she declines it is almost always because nobody has published the answer. That refusal is worth more than the question. It is a customer telling us what is missing from the website.
                  </p>
                  {" "}
                </div>
                {" "}
              ...
              <div className="adm-banner">
                ...
                <span>
                  {" "}
                  <b>
                    One row is one question, not one conversation.
                  </b>
                  {" "}
                  <p>
                    Five people asking the same thing is a single gap, and the number who asked is the size of it. Answering it once fixes the website, Ada, and what the sales team says, all at the same moment.
                  </p>
                  {" "}
                </span>
                {" "}
