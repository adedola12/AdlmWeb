...
// Ported from RichardEnoch/adlm-studio-site src/admin-issued.html
...
export default function DsAdminIssued() {
  return (
    <>
      {/* bar Issued | Documents */}
      {" "}
      <div className="adm-shell" data-screen="issued">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/issued" className="on" aria-current="page" data-tip="Issued">
                <svg viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Every document that has left the studio, newest first. It answers the question that actually gets asked &mdash;{" "}
                    <em>
                      you never sent it
                    </em>
                    {" "}&mdash; and it is assembled from what the panel already knows it issued rather than a second list to keep in step.
                  </p>
                  {" "}
                </div>
                {" "}
