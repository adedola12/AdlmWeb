...
// Ported from RichardEnoch/adlm-studio-site src/admin-system.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminSystem() {
  return (
    <>
      {/* bar System | Admin */}
      {" "}
      <div className="adm-shell">
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/system" className="on" aria-current="page" data-tip="System">
                <svg viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    The settings that are spread across four tools today, in one place, who holds admin rights, what runs on a schedule, what Ada costs, everything anybody has done here, and the one action that stops every customer working.
                  </p>
                  {" "}
                </div>
                {" "}
