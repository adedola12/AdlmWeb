...
// Ported from RichardEnoch/adlm-studio-site src/dash-learning.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashLearning() {
  return (
    <>
      <div className="dsh">
        {" "}
          ...
          <div className="dsh-in">
            ...
            <div className="wk-head">
              ...
              <div>
                ...
                {" "}
                <p>
                  Two enrolments on this account. Every lesson is watchable here, with its transcript and its resources, and the certificate is issued to the account when the capstone is marked.
                </p>
                {" "}
              </div>
              {" "}
              <div className="wk-acts">
                {" "}
                <Link className="ds-btn btn-o ds-btn-sm" to="/learn" data-ds-page="learn">
                  Free lessons
                </Link>
                {" "}
            ...
            <section className="wk-panel">
              ...
              <div className="wk-ph">
                <h2>
                  Free lessons watched
                </h2>
                {" "}
                <Link className="more" to="/learn" data-ds-page="learn">
                  The public library
                </Link>
              </div>
              {" "}
              ...
              {" "}
              <p className="wk-note">
                Fifteen walkthroughs, no sign-in and no payment. Useful for the two people in the practice who have no seat yet.
              </p>
              {" "}
            </section>
            {" "}
