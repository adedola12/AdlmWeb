...
// Ported from RichardEnoch/adlm-studio-site src/admin-certificates.html
...
export default function DsAdminCertificates() {
  return (
    <>
      {/* bar Certificates | Learning */}
      {" "}
      <div className="adm-shell" data-screen="certificates">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/certificates" className="on" aria-current="page" data-tip="Certificates">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#hi-cert" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Every certificate issued on the ADLM template: reissued if somebody loses one, revoked if it went out in error, and findable when an employer asks whether it is real.
                  </p>
                  {" "}
                </div>
                {" "}
