...
// Ported from RichardEnoch/adlm-studio-site src/admin-coupons.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsAdminCoupons() {
  return (
    <>
      {/* bar Coupons | Commerce */}
      {" "}
      <div className="adm-shell" data-screen="coupons">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/coupons" className="on" aria-current="page" data-tip="Coupons">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#ai-tag" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    Discount codes, what each takes off, and how much it has been used against its cap.
                  </p>
                  {" "}
                </div>
                {" "}
