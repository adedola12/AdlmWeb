...
// Ported from RichardEnoch/adlm-studio-site src/admin-templates.html
...
export default function DsAdminTemplates() {
  return (
    <>
      {/* bar Templates | Documents */}
      {" "}
      <div className="adm-shell" data-screen="templates">
        {" "}
        {/* arail */}
        {" "}
        ...
        <aside className="adm-rail adm-scroll" aria-label="ADLM admin">
          ...
          <ul className="adm-nav">
            ...
            {" "}
            <li>
              <Link to="/admin/templates" className="on" aria-current="page" data-tip="Templates">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <use href="#wi-library" />
                </svg>
                <span className="lb">
              ...
              <div className="adm-pagehead">
                ...
                <div>
                  ...
                  <p className="adm-lede">
                    What the engine can produce and whose paper each one prints on. These are the same templates a customer&rsquo;s exports come out of, which is why an ADLM invoice and a practice&rsquo;s bill of quantities look like the same firm made them.
                  </p>
                  {" "}
                </div>
                {" "}
