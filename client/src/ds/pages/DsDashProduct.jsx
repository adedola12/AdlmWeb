...
// Ported from RichardEnoch/adlm-studio-site src/dash-product.html
// Re-run the script to pick up his changes; hand edits here are lost.
import React from "react";
import { Link } from "react-router-dom";

export default function DsDashProduct() {
  return (
    <>
      <div className="dsh">
        {" "}
        ...
        {" "}
        {" "}
        {/* One page, five products. dash.js reads ?p= and fills every [data-p] slot from the
     PRODUCTS map; QUIV is the markup default so the page reads correctly with no query. */}
        {" "}
        <main className="dsh-main" data-product-page="">
          {" "}
          <div className="dsh-in">
            ...
            <div className="dsh-head">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                {" "}
                <img data-p="icon" src="/ds/ic-quiv.png" alt="" style={{ width: "52px", height: "52px", objectFit: "contain" }} />
                {" "}
                <div>
                  {" "}
                  <h1 data-p="name">
              ...
              <div className="dsh-acts">
                {" "}
                <Link className="ds-btn btn-o ds-btn-sm" to="/manage/downloads" data-ds-page="dash-downloads">
                  Installers
                </Link>
                {" "}
            ...
            {" "}
            <div className="dsh-seg" data-pswitch="" style={{ marginBottom: "22px" }}>
              {" "}
              <button type="button" data-f="quiv" className="on">
                QUIV
              </button>
              {" "}
              <button type="button" data-f="rategen">
                RateGen
              </button>
              {" "}
              <button type="button" data-f="heron">
                HERON
              </button>
              {" "}
            ...
            {" "}
            <div className="dsh-stats" style={{ gridTemplateColumns: "repeat(3,1fr)" }}>
              {" "}
              ...
              <div className="dsh-stat">
                ...
                {" "}
                <p className="ds-sub" data-p="seatNote">
              ...
              <div className="dsh-stat">
                ...
                {" "}
                <p className="ds-sub">
                  Activation follows the device, not the person
                </p>
                {" "}
              </div>
              {" "}
            ...
            <div className="dsh-two">
              ...
              <div>
                ...
                <section className="dsh-panel">
                  ...
                  {" "}
                  <div className="dsh-body" data-p="holders">
                    {" "}
                    <div className="dsh-prod">
                      {" "}
                      <span className="dsh-avi" style={{ width: "34px", height: "34px", borderRadius: "11px", fontSize: "11px" }}>
                        TA
                      </span>
                      {" "}
                      <div className="nm">
                        ...
                        <span>
                          Principal Partner · TUNDE-WS02 · active today
                        </span>
                      </div>
                      {" "}
                    ...
                    <div className="dsh-prod">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          Senior QS · CHIDI-LT01 · active yesterday
                        </span>
                      </div>
                      {" "}
                      <span className="pill pill-a">
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-ph">
                    ...
                    {" "}
                    <button type="button" className="more" data-modal="releases">
                      All release notes
                    </button>
                  </div>
                  {" "}
                  <div className="dsh-body">
                    {" "}
                    <ul className="dsh-rel" data-p="notes">
                      {" "}
                      <li className="now">
                        <span className="v">
                          v3.1.7
                        ...
                        <span className="d">
                          31 July 2026 · installed
                        </span>
                        {" "}
                        <p>
                          The built-in fallback service address now points at the live service, so a manual install that bypassed the Installer Hub can no longer fail to sign in.
                        </p>
                      </li>
                      {" "}
                      <li>
                        ...
                        {" "}
                        <p>
                          Faster element scans on large models, and the dockable panel reflows properly when narrowed against the Revit properties palette.
                        </p>
                      </li>
                      {" "}
                      <li>
                        ...
                        {" "}
                        <p>
                          Margin and budget view added alongside the bill, so the priced position is visible without exporting.
                        </p>
                      </li>
                      {" "}
                    </ul>
              ...
              <div>
                ...
                <section className="dsh-panel">
                  ...
                  <div className="dsh-body">
                    ...
                    <div className="dsh-dl">
                      ...
                      {" "}
                      <button type="button" className="ds-btn btn-o ds-btn-sm" data-modal="guides">
                        Open
                      </button>
                      {" "}
                    </div>
                    ...
                    <div className="dsh-dl">
                      ...
                      <div className="nm">
                        ...
                        <span>
                          Walkthroughs, no sign-in needed
                        </span>
                      </div>
                      {" "}
                      <button type="button" className="ds-btn btn-o ds-btn-sm" data-modal="lessons">
                        Watch
                      </button>
                      {" "}
                    </div>
                ...
                {" "}
                <div className="dsh-hub" style={{ marginTop: "20px" }}>
                  {" "}
                  <h3>
