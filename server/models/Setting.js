...
const SettingSchema = new mongoose.Schema(
  {
    ...
    // YouTube ids an admin removed from the free library. The fifteen-minute
    // auto-filer (util/freeLibraryAuto.js) never puts these back.
    freeLibraryIgnored: { type: [String], default: [] },
